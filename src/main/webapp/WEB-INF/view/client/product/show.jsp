        ...
        <div class="row">
                        ...
                        <div class="recent_product_container">
                            <div class="recent_product_list">
                                ...
                                <div class="recent_product_content">
                                    <h3>
                                        <a href="product-details.html" >Natus erro</a>
                                    </h3>
                            ...
                            <div class="recent_product_list">
                                ...
                                <div class="recent_product_content">
                                    <h3>
                                        <a href="product-details.html" >Nemo enim</a>
                                    </h3>
                                    <div class="product_rating">
                                        <ul>
                                            <li>
                            ...
                            <div class="recent_product_list">
                                <div class="recent_product_thumb">
                                    <a href="product-details.html"
                                    ><img
                                            src="/client/img/s-product/product3.jpg"
                                            alt="" /></a>
                                </div>
                                <div class="recent_product_content">
                                    <h3>
                                        <a href="product-details.html" >Consequuntur magni</a>
                                    </h3>
                                    <div class="product_rating">
                                        <ul>
                                            <li>
                            ...
                            <div class="recent_product_list">
                                <div class="recent_product_thumb">
                                    <a href="product-details.html"
                                    ><img
                                            src="/client/img/s-product/product4.jpg"
                                            alt="" /></a>
                                </div>
                                <div class="recent_product_content">
                                    <h3>
                                        <a href="product-details.html" >Cras neque</a>
                                    </h3>
                                    <div class="product_rating">
                                        <ul>
                                            <li>
                            ...
                            <div class="recent_product_list">
                                <div class="recent_product_thumb">
                                    <a href="product-details.html"
                                    ><img
                                            src="/client/img/s-product/product5.jpg"
                                            alt="" /></a>
                                </div>
                                <div class="recent_product_content">
                                    <h3>
                                        <a href="product-details.html" >Endurance2</a>
                                    </h3>
                                    <div class="product_rating">
                                        <ul>
                                            <li>
                            ...
                            <div class="recent_product_list">
                                <div class="recent_product_thumb">
                                    <a href="product-details.html"
                                    ><img
                                            src="/client/img/s-product/product6.jpg"
                                            alt="" /></a>
                                </div>
                                <div class="recent_product_content">
                                    <h3>
                                        <a href="product-details.html" >Crown Summit1</a>
                                    </h3>
                                    <div class="product_rating">
                                        <ul>
                                            <li>
                            ...
                            <div class="recent_product_list">
                                <div class="recent_product_thumb">
                                    <a href="product-details.html"
                                    ><img
                                            src="/client/img/s-product/product7.jpg"
                                            alt="" /></a>
                                </div>
                                <div class="recent_product_content">
                                    <h3>
                                        <a href="product-details.html" >Compete Hoodie3</a>
                                    </h3>
                                    <div class="product_rating">
                                        <ul>
                                            <li>
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="shop_banner">
                    <img src="/client/img/bg/banner29.jpg" alt=""/>
                </div>
                                ...
                                <div class="action_links">
                                    <ul>
                                        ...
                                        <li class="add_to_cart">
                                            <a href="cart.html"
                                                    title="add to cart" ><i class="zmdi zmdi-shopping-cart-plus" ></i>
                                                add to cart</a>
                                        </li>
                                        <li class="compare">
                            ...
                            <div class="product_content list_content">
                                ...
                                <div class="product_desc">
                                    <p>
                                        ...
                                        Fusce posuere metus vitae arcu
                                        imperdiet, id aliquet ante
                    ...
                    <div class="col-12">
                        <div class="single_product">
                            ...
                            <div class="product_content grid_content">
                                <div class="product_name">
                                    <h3>
                                        <a href="product-details.html" >Aliquam lobortis Camera</a>
                                    </h3>
                                </div>
                                <div class="product_rating">
                                    <ul>
                    ...
                    <div class="col-12">
                        <div class="single_product">
                            ...
                            <div class="product_content grid_content">
                                <div class="product_name">
                                    <h3>
                                        <a href="product-details.html" >Aliquam lobortis est</a>
                                    </h3>
                                </div>
                                <div class="product_rating">
                                    <ul>
