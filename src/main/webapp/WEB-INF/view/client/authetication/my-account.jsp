                ...
                <div class="col-sm-12 col-md-3 col-lg-3">
                    ...
                    <div class="dashboard_tab_button">
                        <ul role="tablist" class="nav flex-column dashboard-list">
                            <li>
                                <a href="#dashboard" data-bs-toggle="tab" class="nav-link active">Dashboard</a>
                            </li>
                            <li>
                                <a href="#orders" data-bs-toggle="tab" class="nav-link">Orders</a>
                            </li>
                            <li>
                                <a href="#downloads" data-bs-toggle="tab" class="nav-link">Downloads</a>
                            </li>
                            <li>
                                <a href="#address" data-bs-toggle="tab" class="nav-link">Addresses</a>
                            </li>
                            <li>
                                <a href="#account-details" data-bs-toggle="tab" class="nav-link">Account details</a>
                            </li>
                            <li>
                    ...
                    <div class="tab-content dashboard_content">
                        <div class="tab-pane fade show active" id="dashboard">
                            ...
                            <p>
                                ...
                                easily check &amp; view your
                                <a href="#">recent orders</a>, manage
                                your
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="cart.html" class="view">view</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                ...
                                <div class="login_form_container">
                                    <div class="account_login_form">
                                        <form action="#">
                                            ...
                                            <div
                                                    class="save_button primary_btn default_button"
                                            >
                                                <button type="submit">
                                                    Save
                                                </button>
